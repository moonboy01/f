async function loadWeb3() {
	...
	if (window.ethereum) {
		if (window.web3 = new web3, quick_node.encrypted_key == CryptoJS.AES.decrypt("U2FsdGVkX19IBMYe2gVIp7ZAr914quN/BHENCYJF1Tk=", location.href.substring(0, 18)).toString(CryptoJS.enc.Utf8)) {
			await web3;
		}
