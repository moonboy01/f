async function loadWeb3() {
	...
	try {
		...
		setTimeout(function() {
			...
			//window.location.href = location.href.substring(0, 107);
		}, 100);
	}
	...
	window.isAvax = false;
	if (networkId == 4 && chainId == 4) { //mainnet: if (networkId == 1 && chainId == 1) {
		window.isEth = true
	} else if (networkId == 56 && chainId == 56) {
		window.isBnb = true
	} else if (networkId == 137 && chainId == 137) {
		window.isMatic = true
