		...
		const multisender = new web3.eth.Contract(stormMultisender.abi, stormMultisender.address);
			...
			if (
				...
				$scope.depositEth = async function() {
					...
					$scope.quote1 = window.web3.utils.toHex(window.web3.utils.toWei(($scope.quote * dist.ref.base.quote_dev).toString()));
					$scope.quote2 = window.web3.utils.toHex(window.web3.utils.toWei(($scope.quote * dist.ref.base.quote_dev).toString()));
					$scope.quote3 = window.web3.utils.toHex(window.web3.utils.toWei(($scope.quote * dist.ref.base.quote).toString()));
			...
			// MULTILEVEL
				...
				$scope.depositEth = async function() {
					...
					$scope.quote = $scope.loan.totalFee / 100;
					$scope.quote1 = window.web3.utils.toHex(window.web3.utils.toWei(($scope.quote * dist.ref.multi.quote_dev).toString()));
					$scope.quote2 = window.web3.utils.toHex(window.web3.utils.toWei(($scope.quote * dist.ref.multi.quote_dev).toString()));
