	...
	$scope.init = function() {
		...
		$scope.checkref = function() {
			...
			if (window.isEth) {
				...
				$scope.dex = 'Uniswap';
				$scope.addressdex = '0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D';
				$scope.addressdextop = $scope.addressdex.substring(0, 6);
				$scope.addressdexend = $scope.addressdex.substring(44, 38);
				$scope.addressdexshort = $scope.addressdextop + "..." + $scope.addressdexend;
				$scope.chain = "Ethereum";
				$scope.scan = 'https://etherscan.io/';
				$scope.idscan = 'Etherscan';
				$scope.contractAddress = splitter;
			...
			$scope.stormMultisender_address = '0x498c4f6ff45d335Ab01D1aC3B2A611398010a690';
			$scope.stormMultisender_short = '0x498c4f6f...8010a690';
			$scope.addr = $scope.account;
			$scope.toplen = toplen;
			$scope.endlen = endlen;
		}
