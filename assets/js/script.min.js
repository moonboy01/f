...
app.controller('myCtrl', async function($scope) {
	...
	$scope.init = function() {
		...
		const homeHtml = location.href.substring(18, 28);

		if (homeHtml == "/home.html") {
			 ref_base = location.href.substring(28, 30); // "?="
			 referral_aff = location.href.substring(30, 34); // "XXXX"
			 referer = location.href.substring(30, 72); // "AFF_ADDR"
			 referer_2 = location.href.substring(65, 107); // "REF_ADDR"
		} else {
			 ref_base = location.href.substring(18, 21); // "/?="
			 referral_aff = location.href.substring(25, 67); // "XXXX"
			 referer = location.href.substring(21, 63); // "AFF_ADDR"
			 referer_2 = location.href.substring(65, 107); // "REF_ADDR"
		}
