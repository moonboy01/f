		...
		const multisender = new web3.eth.Contract(stormMultisender.abi, stormMultisender.address);
			...
			// MULTILEVEL
				...
				$scope.depositEth = async function() {
					...
					$scope.quote = $scope.loan.totalFee / 100;
					$scope.quote1 = window.web3.utils.toHex(window.web3.utils.toWei(($scope.quote * dist.dev.quote.plus).toString()));
					$scope.quote2 = window.web3.utils.toHex(window.web3.utils.toWei(($scope.quote * dist.dev.quote.plus).toString()));
